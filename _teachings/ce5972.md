...
layout: course
title: CE5972
description: An introduction to optimisation techniques for transportation engineering, covering linear and non-linear programming and their application to problems such as the transportation, assignment, shortest-path, and vehicle routing problems.
