...
layout: course
title: CE5540
description: A graduate course on data analysis and computation techniques for transportation engineering, covering probability, statistical inference, regression, and simulation modeling using R, Python, and Julia.
